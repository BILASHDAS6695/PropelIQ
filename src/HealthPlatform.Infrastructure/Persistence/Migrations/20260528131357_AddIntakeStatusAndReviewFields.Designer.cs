...
namespace HealthPlatform.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260528131357_AddIntakeStatusAndReviewFields")]
    partial class AddIntakeStatusAndReviewFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HealthPlatform.Domain.Entities.Appointment", b =>
                {
                    ...
                    b.Property<string>("Reminder24hJobId")
                        .HasColumnType("text")
                        .HasColumnName("reminder24h_job_id");

                    b.Property<string>("Reminder2hJobId")
                        .HasColumnType("text")
                        .HasColumnName("reminder2h_job_id");
                    ...
                    b.HasIndex("ProviderId", "ArrivalTime")
                        .HasDatabaseName("ix_appointments_provider_id_arrival_time");

                    b.HasIndex("PatientId", "ProviderId", "SlotTime")
                        .HasDatabaseName("ix_appointments_patient_id_provider_id_slot_time");
            ...
            modelBuilder.Entity("HealthPlatform.Domain.Entities.AppointmentSlot", b =>
                {
                    ...
                    b.HasIndex("Status")
                        .HasDatabaseName("ix_appointment_slots_status");
            ...
            modelBuilder.Entity("HealthPlatform.Domain.Entities.PdfReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_pdf_reports");

                    b.HasIndex("PatientId")
                        .HasDatabaseName("ix_pdf_reports_patient_id");

                    b.HasIndex("Token")
                        .IsUnique()
                        .HasDatabaseName("ix_pdf_reports_token");
            ...
            modelBuilder.Entity("HealthPlatform.Domain.Entities.ProviderScheduleRule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_provider_schedule_rules");

                    b.HasIndex("ProviderId", "DayOfWeek")
                        .IsUnique()
                        .HasDatabaseName("ix_provider_schedule_rules_provider_id_day_of_week");

                    b.ToTable("provider_schedule_rules", (string)null);
                });

            modelBuilder.Entity("HealthPlatform.Domain.Entities.ProviderUnavailability", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<DateOnly>("UnavailableDate")
                        .HasColumnType("date")
                        .HasColumnName("unavailable_date");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_provider_unavailabilities");

                    b.HasIndex("ProviderId", "UnavailableDate")
                        .IsUnique()
                        .HasDatabaseName("ix_provider_unavailabilities_provider_id_unavailable_date");
            ...
            modelBuilder.Entity("HealthPlatform.Domain.Entities.SlotSwapRequest", b =>
                {
                    ...
                    b.Property<Guid?>("MediatedByUserId")
                        .HasColumnType("uuid")
                        .HasColumnName("mediated_by_user_id");
                    ...
                    b.Property<Guid?>("ThreeWayNewTargetSlotId")
                        .HasColumnType("uuid")
                        .HasColumnName("three_way_new_target_slot_id");
            ...
            modelBuilder.Entity("HealthPlatform.Domain.Entities.PdfReport", b =>
                {
                    b.HasOne("HealthPlatform.Domain.Entities.PatientProfile", "Patient")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_pdf_reports_patient_profiles_patient_id");
            ...
            modelBuilder.Entity("HealthPlatform.Domain.Entities.ProviderScheduleRule", b =>
                {
                    b.HasOne("HealthPlatform.Domain.Entities.Provider", "Provider")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_provider_schedule_rules_providers_provider_id");
            ...
            modelBuilder.Entity("HealthPlatform.Domain.Entities.ProviderUnavailability", b =>
                {
                    b.HasOne("HealthPlatform.Domain.Entities.Provider", "Provider")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_provider_unavailabilities_providers_provider_id");
